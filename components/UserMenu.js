...
const MenuItem = (props) => {
    ...
    return (
        ...
        <div className="cursor-pointer mb-1 p-1 bg-green-darkest hover:bg-green-darker text-white">
    ...
    render = () => {
        return (
            <div className="h-12">
                ...
                <div id="user-menu" className={"bg-grey-light "+this.state.menuDisplay}>
                    <MenuItem title="Profile" url="#" />
                    <MenuItem title="Upload CV" url="#" />
                    <MenuItem title="Upload CL" url="#" />
                    <MenuItem title="Logout" url="#" />
                </div>
